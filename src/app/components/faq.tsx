...
export default function FAQ() {
  ...
  return (
   ...
   <div className="w-100 p-6 flex  items-center  justify-center flex-col">
        ...
        <p className="text-white text-center">We've compiled a list of the most frequently asked questions to help you understand its features and benefits.</p>
        <br></br>
